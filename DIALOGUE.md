...
- **Exchange `cellar`** (avail: found the cellar key) — "About that cellar of yours." / "A lot of doors in this town stay locked. You keep a cellar under this place?"
...
- **Exchange `car`** — "Is there a mechanic in town?" / "My car won't start. Turns over and won't catch. Is there anyone in town who could take a look at it?"
  - (npc) "A mechanic? No, nothing like that here now, and it would not help you if there were."
  - (npc) "The car is not broken, friend. I could not tell you what ails it, and I would not lose sleep on it."
