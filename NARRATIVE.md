...
| **Jan 15, 1994** | The closing rite in the mine chamber. The Mask manifests on the altar, the seal snaps shut, and every soul inside the town line is claimed at once. Deliveries stop; Mara stops calling home; the news rack takes its last delivery, and every copy still in it carries this date. Three months of sealed winter follow. |
...
- The door woke **~April 1993**; the seal is **Jan 15, 1994**; the
  frozen news rack still carries that date on every copy; the Ledger's
  checkout dates stop a year back. (**The calendars are cut** and nothing
  reinstates the prop; guarded: `tests/flow.py` §23a.) → §3
