...
| **Seal the threshold** — *END IT* | You give the **keystone** (the Mask seated in the cult's notes) to the door; contain the hunger; **every acre the cult bent is warped whole into Carcosa** — the map's edges grow together over the place, and **Brimley simply was** | Ending sequence. *"It is done. Nothing leaves Brimley again. Not the hunger. Not you."* | `_play_ending("seal_threshold")` (exists; now **consumes the keystone at the doorframe**, §below — a code change) |
