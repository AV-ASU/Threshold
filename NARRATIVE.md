...
never reaches the world — and it **admits but never releases**. You
drove in without trouble; only *out* loops. Nothing leaves unless it
carries a shard of His authority, so there are two ways out and both
damn something: **down** to the source to end it, or out past the corn
as the breach itself, the **Sign** in your hands, to spread it.

**Why you.** A year ago the PI dreamed of the door once, walked up,
looked in, and for a blip met His eye. The dream never took root, so the
pull never had him — but a soul that walks to the glass and doesn't fall
is the thing He remembers. The PI is the only outsider to enter since
the seal closed: **unclaimed, barely attuned, and known to Him**. That
exact profile is what lets the fold open for him alone, and what makes
the King's hunt personal rather than reflexive: the one that got away,
come back.

**You were lured.** The case is an engineered chain: King → (claimed)
Mara → her father Walter → the marked PI. He used the daughter He had
already taken to work on her father; the father's genuine grief hired
the one investigator the King wanted. Walter is real and unwitting — his
grief is an instrument, never a fiction. The door answers desire, and He
found a numb man's one remaining appetite: an unsolved thing. This is
felt only as the PI's own unease in the notebook, and stays otherwise
unspoken in the game.

**He is powerful, not omniscient.** The chain is opportunism that
worked, not clockwork He computed — the rare, gloating luck of a vast
thing finding exactly the right hand to reel in the one that got away.
Keep the seam of chance in it: He is huge, patient, and lucky, and the
dread depends on all three.

**Tone:** *Darkwood* (oppressive hide-or-die dread, spreading
corruption, bleak and ambiguous) + *Fear & Hunger* (grimdark descent to
the god at the bottom, ritual, no clean win).

**The name.** *THRESHOLD.* The door in the deep is a frame that looks
like the way out of the maze and is only ever the way further in — the
exit that is a descent. That is the town, the case, and the player's two
endings in one image.

---

## 2. The Door and the Dream
...
the cave floor lies impossibly, perfectly level, and on that plane
stands a **doorframe**: plain, blank, unmarked, too slight to hold
itself upright, standing dead straight. Near the door, geometry serves
the door — the level floor, the impossible uprightness, and the looping
roads above are the same wrongness at different sizes. The frame is the
threshold to **Carcosa**, the King's dead city, and it is a one-way
window He looks *out* of. Walk through it and you stand in the same
room, on the far side of an empty frame. It never opens, and Carcosa
appears only when the King takes you — the not-knowing is the flame,
and the player's curiosity is the engine. Spend it never.

**The river woke it.** Carcosa always touched the world here faintly;
Brimley was always a little wrong, a river town that "keeps what it
takes." The door made the ground beneath it unnaturally flat and low,
and water finds the low places: about a year ago the first thread of
the underground river reached the frame and crossed its plane. The
world touched the glass, and on the far side He looked out. Gravity did
it — the river is patient zero, and it isn't even a person. The river
is the artery of the whole nightmare and the path the diggers followed.

**The dream is the lure.** Once awake, the door broadcasts a dream: you
stand on the level floor and take step after step toward the frame, and
the distance never closes. The broadcast is weak, wide, and rarely
caught — only the few highly **attuned** receive it, scattered anywhere,
and they follow it to the source. Attunement is a susceptibility, never
a choice, and it is **the size of the hole you carry**: the door
whispers the answer to the hardest thing in your life and tells you it
is just on the other side. Each person is offered the one thing they
already ache for, which is why they go gladly and why it never reads as
a trick. Despair is attunement, which is how the spent slide cult-ward
by attrition. The unattuned never dream and never know the door exists,
which is exactly why locals can be wholly, innocently unaware of the
thing under their town.

This is the engine of the game and the key to its darkest beat:
**Mara was answered, not deceived.** There was never anyone to save,
...
returned. The notebook carries that dream as a half-dismissed memory of
a door he never reached. His numbness is a character, not a
convenience — and the cruelty of the lure is that He found the one
appetite a numb investigator can't refuse.

**Two stages, two jobs.** The door recruits *individuals* — the
attuned, by dream; that is how the cult gathered. The closing rite
claims the *collective* — at one stroke it bound every soul inside the
town line: attuned or stone, willing or oblivious, adults and children.
The rite is what nets the oblivious locals; the dream alone can't claim
someone who never dreams.

**Being claimed leaves no visible mark.** Nobody glows, nobody kneels
in the street; the visible wrongness of Brimley is the rot and the
folds — the *place*, not the people. What separates the town's two
halves is knowledge: the unbaited locals were claimed without ever
knowing it and live entirely His with no idea of it; the cult knew the
gist of their own bargain — they gave themselves over for the answer
the door promised — and their certainty is compulsion, never
comprehension. The whole town reads normal and is entirely His; the
only soul who can feel the seam is the one outsider who wasn't in the
net when it closed.

**The rite and the Mask.** The congregation's ongoing rite seals the
town, and the **Sign — the Pallid Mask — is that rite's keystone, the
seal itself made into an object**. At the rite's climax the Mask
manifested on their altar: the built-up energy was finally enough for
the King to push His own face through from Carcosa. Unbound, His only
reach into the flat world is the dream; the completed rite is the one
thing that lets Him extend a single solid object, the Mask, no more.
The cult cannot finish the seal without the Mask and He cannot send the
Mask without their rite — neither closes the loop alone. The rite does
two jobs at once: **it seals Him in and it feeds Him.** Every claimed
soul is a cell in the battery; Brimley is His power bank, and the
pressure only mounts. The fold is not a cage for you — **it is the cage
for Him** — and the rite would hold and feed forever. The PI's arrival
is the first thing that can decide its fate; that single inversion
drives the endings: the kneeling cult you'll want to stop is the only
lid on the pot.

**What it actually is — the author's model, delivered only as
sensation.** The door is an aperture to a higher dimension; the King
lives *above* our plane. To flat beings He is perceivable only as a
shifting cross-section (the drifting masks in fire are a slice of Him),
the Yellow Sign is His flattened shadow, and the dream's distance never
closes because the way through is perpendicular to your plane. To be
claimed is to be gripped by something orthogonal to all your senses; to
be taken is a 2D being picked up out of the only space it has ever
known. The discipline: this truth arrives **only as sensation** — the
unfinishable dream, the wrongness, the slice-glimpse, the lifting
feeling. Keep Brimley a dull, real town with one unexplained door, and
keep the door unexplained; the moment any line names the model, the
folk horror dies into sci-fi.

**Space folds; time runs.** The binding is spatial. Roads loop, the way
home folds back in, walk for the town line and you walk back in — but
the ice goes out, the season turns, three months have passed since the
seal. The dread of time here is **stasis**, and the days move forward
normally. The word *fold* belongs to the road, always to the road, and
the calendar keeps ordinary time.

---

## 3. Timeline

The chronology every dated reference in the game agrees with; check new
text against it. The present is a single stretch of days; everything
above it is why.

| When | Event |
|------|-------|
| *a prior cycle* | The door has taken a place before. The spent surface altar by the river is the cap left by that earlier sealing. Kept deliberately vague: it signals the cycle, nothing more. |
...
> stand: tithed down in the fall, never cut, dead stalks that should
> have fallen by now and haven't. Part of the wrongness; it needs no
> line of dialogue, and all text treats the corn as dead standing straw.
...
- **Locals** — born here, watched their town fall in on itself over a
  few months. They haven't mapped the fold; they've learned futility.
  They cope by surrender, and when they speak of the roads they
  describe failure, never pattern.
- **Newcomers** — the attuned, arrived over the last year, drawn by the
  door's dream (§2). They "found religion." They smile and act like
  they belong here. They are the cult.
- **The PI** — the only outsider in since the fold closed. Unclaimed;
  the one thing in Brimley the fold doesn't own.

The locals are TRAPPED WITH the newcomers — that is the specific dread.
And the cult are **ordinary people with bodies**: they sleep, buy food,
eat normal meals, return borrowed shovels. The horror is domestic. The
cult **claims souls** (§2); every appetite in the fiction is spiritual,
and the town's hunger problems are logistics (the deliveries stopped),
never predation.
...
| **Sheriff Hollis Vane** | **Local — the last holdout; claimed but never attuned** | Alone among the named cast he never dreamed the door. Not a believer: the town's one real investigator, chasing the *how* — how a pack of outsiders talked his town into walking off and shut it. His single window into it is one post-seal conversation with a nameless congregant, wrecked and certain at once, who had been promised by the dream that his wife would know him again when the work was finished, and who was in truth sent to convert him. (Her want is ORDINARY and unfixable, per §2 and `DESIGN.md` §8: she is alive in a county home and does not know his face. The door deals in bearings, not miracles, so no want in the fiction is a physical repair.) Vane refused; from that one exchange he holds the only piece of the how — the door answers your deepest want. He knows the outsiders filled the school, barn, and lodge, then walked out one night in a line; the King, the Threshold, and where the line went are beyond him. What he wants most is for all of it to end. Toward the PI he is hopeful but mistrusting — one more outsider who drove in is the exact profile of every cultist — and trust is earned only as the PI shares real discoveries. His fall is player-driven (`DESIGN.md` §2). |
...
- **The grove.** A hollow north of Brimley, above the river: the mouth
  ...
  its edges wear the fold's own wrap, so it is reached by the school
  rite alone, hidden rather than locked.
...
- **The Threshold.** The doorframe on the level floor where the
  ...
  altar below (this cycle's rite, the current Mask), and the surface
...
so losing the person can never soft-lock the descent (the Sable-drop
precedent). The paper opens when the person is no longer there to hand
it over: Hettie dead, Vane dead **or gone hollow**. This makes
**Hettie, Vane, and Toby** the load-bearing locals.

The warm way is the point, not a courtesy: **each of these three knew
her**, and the photograph is what proves it. Hettie sold to her week on
week; **Vane booked her himself** and recognizes her on sight, so his
answer to the photograph is the arrest, not a shrug; Toby was given her
bear. A local who could not place her is a local with no record of her
to hand over.
...
Strictly vertical, and **the rite is the only way down** — the well
goes nowhere a player can follow, the barn hatch is nailed shut from
below, and the mine has one mouth. In order:

1. **Arrive.** The night before the game opens, the PI drives in, the
   fold kills the car, and he takes the spare room at the Arcadia
   (§3). The car answers only to the Sign — Brimley itself is the
   lock, and only a shard of Him opens it.
2. **Investigate.** Read the town and its locals; gather evidence.
3. **Cross 3 evidence.** The town wakes to him, the King arms, and
   Sable hands over the **Invitation** — the envelope the congregation
   left at the desk when they went below.
4. **The school rite.** Incense at the commune's indoor fire, then the
   ...
   cult's mine.
5. **The mine mouth.** The grove is the mine's dug mouth: a green HILL in the
   middle of the clearing with a dark stone ADIT cut into its south face,
   timbered over like the racks below, the shaft dropping away just inside with
   the cut haul rope hanging into it. Ore carts and spoil stand abandoned
   mid-work along the rail in the yard below it. The rope is CUT (§14), so you
   cannot climb down — you go down by the RITE, and there is **no gate at the
   mouth**
...
7. **The fall.** Mask in hand, powder from the Sump: the **blast** at
   the Works' deepest face — the dig never finished, and the blast
   finishes it — then the one-way fall into the Depths, through the
   hive, to the **Threshold**: finishing, awake, the dream that never
   closed in sleep.
...
Every run ends one of five ways: two pursuits, and the three faces of
one choice.
...
moment you hold it the case has exactly two ends. The Mask reads as
permission to leave, and that is the temptation: the instant you take
it, a note lands — with this, the town will let me out — and it is
true, and it is the trap. Across the descent the PI's notes grow
steadily more distressed, so that when the Mask offers escape the
player already aches to take it. Choosing to go deeper instead — past
the open door home, down to the thing all of this kneels to — is the
harder, costlier road, and that is the point. The fork is experiential,
never a menu.

The rite is a **pressure vessel** holding the King compressed, and the
order rule governs all three outcomes:

- **SEAL / END IT.** Carry the keystone down and give it to the door;
  it is spent at the Threshold, at the frame itself. The geometry
  closes and every acre the cult bent is warped whole into Carcosa —
  the town, the ground, the hunger, and the PI — and the county's
  edges grow together over the place. Brimley simply *was*. The world
  is spared and unknowing; the King is contained, never destroyed; the
  door goes quiet with the altar-cap its only marker, and the cycle
  waits for the next place water reaches. Presentation: the live warp,
  the lines on black under the black stars and twin suns, the wordless
  wide shot (lines flow-guarded).
...
- **BREAK / the trap.** Tear the Mask down at the Sign Chamber altar —
  in place, source still open. Because the Mask IS the seal, this
  uncaps a pressurized pot: His influence floods out uncontained, here
  and now, everyone taken immediately, the PI included. A game over,
  wordless by design: the truth that the cage is for Him is learnable
  beforehand through the cult's own notes, and the ending states
  nothing.

**The cruel teach.** The game sequences the player to meet the rite
...
## 9. The Cult's Testimony

Three fragments of the congregation's personal testimony, pure lore
that gates nothing. Each is written in the congregation's own voice —
...
|---|---|---|---|
| **The Calling** | `cult_calling` | The Scriptorium — the one bound, whole volume among the loose Sign copies | How the dream gathered them: the drink taken away clean, the lost farm, a hundred strangers driving north to the same town. |
| **The Bargain** | `cult_bargain` | The Sump | What they understood they gave: everything, and only the once. |
| **The Digging** | `cult_digging` | The Old Stores | The labor eating the self: shifts that never stop, a few feet of earth left, the door repeating in the mind. |

---

## Canon invariants — do not regress

Facts a scene, a line, or a test depends on. Change these only on
purpose, and keep each one guarded where a guard exists.

- The PI dreamed the door **exactly once, a year ago, and never reached
  it**; the journal reminds him of that single dream, and every mention
  of it stays in that shape (guarded: the dream note says "a year" and
  carries no recurrence language). → §2
- The PI arrived **the night before the game opens** (April 14), was
  checked in by Sable, and woke to the present (April 15). Sable's
  dialogue resumes an acquaintance; the town's dates treat April 14 as
  yesterday (guarded: `tests/flow.py` §23a). → §3
- The door woke **~April 1993**; the seal is **Jan 15, 1994**; every
  calendar in town stops at Jan 15; the Ledger's checkout dates stop a
  year back. → §3
- **Space folds; time runs.** The fold is spatial; days move forward;
  the corn is last year's dead stand. → §2, §3
- **Mara walked in willingly.** She was answered, not deceived; she is
...
- **The way home is keyed to the Mask** (the SPREAD lock); **one-way is
  the King's signature alone**. → §7
- **The keystone is spent at the Threshold door** (SEAL), carried out
  (SPREAD), or torn down early (BREAK, the trap); the blast at the
  deepest face is the way deeper, Mask in hand first. → §7, §8
